...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"default\", function() { return setColor; });\nfunction setColor(items, colors) {\r\n  const itemsArray = document.querySelectorAll(items);\r\n\r\n  if (!itemsArray || !colors) return null;\r\n\r\n  let actual = 0;\r\n\r\n  itemsArray.forEach(item => {\r\n    item.classList.add(colors[actual]);\r\n\r\n    actual = actual === colors.length - 1 ? 0 : actual + 1;\r\n  });\r\n}\n\n//# sourceURL=webpack:///./app/js/setColors.js?");
